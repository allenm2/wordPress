...
$post_id = ($fortune_theme_options['portfolio_post'] == ''?'':$fortune_theme_options['portfolio_post']);
$fortune_portfolio_post = get_post($post_id);
	...
	?>
      <div class="col-sm-6 col-md-4 project-item">
        <div class="project-item-inner">
          <figure class="alignnone project-img"> <img src="<?php echo get_template_directory_uri(); ?>/images/samples/p<?php echo $i; ?>.jpg" alt="" />
            <div class="overlay"> <a href="#" class="dlink"><i class="fa fa-link"></i></a> <a href="<?php echo get_template_directory_uri(); ?>/images/samples/p<?php echo $i; ?>.jpg" class="popup-link zoom"><i class="fa fa-search-plus"></i></a> </div>
          </figure>
