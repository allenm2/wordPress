...
<article <?php post_class('entry entry__standard'); ?> >
	<div class="row"><?php
			$col = 12;
		...
		<div class="col-sm-<?php echo $col; ?> col-md-<?php echo (int)$col; ?>">
			<header class="entry-header">
				...
				<div class="entry-meta">
					<span class="entry-date"><?php if(get_the_title()!=""){ echo get_the_date(get_option('date_format'), true);}else{ ?><a href="<?php the_permalink(); ?>"><?php echo get_the_date(get_option('date_format'), true); ?></a><?php } ?></span>
